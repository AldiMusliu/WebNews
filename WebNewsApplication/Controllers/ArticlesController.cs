...
namespace WebNewsApplication.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Author,Contents")] Articles articles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Author,Contents")] Articles articles)
        {
            if (id != articles.Id)
            {
                return NotFound();
